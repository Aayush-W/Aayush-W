...
ROWS = [
    ("host",),
    ("kv", "Now", "Student & Developer"),
    ("kv", "Edu", "B.tech Information Technology"),
    ("gap",),
    ("sec", "Stack"),
    ("kv", "Frontend", "React, HTML, CSS"),
    ("kv", "Backend", "Python, Node.js"),
    ("kv", "AI / ML", "AI, Machine Learning"),
    ("kv", "Other", "Arduino"),
    ("gap",),
    ("sec", "Highlights"),
    ("bul", "Building beautiful web apps & AI solutions"),
    ("bul", "Passionate about technology and learning"),
]
...
parts.append(f'<text x="{W/2}" y="{TITLEBAR_H/2 + 4}" fill="{MUTED}" font-size="12" '
             f'text-anchor="middle">aayush@github: ~$ neofetch</text>')
...
for i, row in enumerate(ROWS):
    ...
    if kind == "host":
        inner = (f'<text x="{KEY_X}" y="{y:.1f}" font-size="14" font-weight="700">'
                 f'<tspan fill="{GREEN}">aayush</tspan><tspan fill="{MUTED}">@</tspan>'
